...
console.log(`📌 결과1: ${identity<number>(42)}`); // Output: 42
console.log(`📌 결과2: ${identity<string>("Hello")}`); // Output: Hello
console.log(`📌 결과3: ${identity<boolean>(true)}`); // Output: true
console.log(`📌 결과4: ${identity<Point>([1, 2])}`); // Output: [1, 2]
...
console.log(`📌 결과1: ${numberBox.getValue()}`); // Output: 123
console.log(`📌 결과2: ${stringBox.getValue()}`); // Output: Hello, TypeScript!
console.log(`📌 결과3: ${booleanBox.getValue()}`); // Output: true
console.log(`📌 결과4: ${pointBox.getValue()}`); // Output: [10, 20]
